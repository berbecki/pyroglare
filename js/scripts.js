...
//		$('#box-menu ul li:not(#dashboard-link)').hoverIntent({
//			sensitivity: 7,
//			interval: 75,
...
//		});
		...
		$(".primary-nav li a.no-submenu").click(function () {
			window.location.href = $(this).attr("href");
			return false;
		});

		$('<div id="ajaxaction">action</div>')
		.insertBefore('.primary-nav')
